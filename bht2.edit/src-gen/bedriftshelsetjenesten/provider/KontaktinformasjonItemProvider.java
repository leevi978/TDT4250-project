...
/**
 * This is the item provider adapter for a {@link bedriftshelsetjenesten.Kontaktinformasjon} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KontaktinformasjonItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTelefonPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Bht2Package.Literals.KONTAKTINFORMASJON__TELEFON, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Kontaktinformasjon_EpostAdresse_feature",
								"_UI_Kontaktinformasjon_type"),
						Bht2Package.Literals.KONTAKTINFORMASJON__EPOST_ADRESSE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addInternettAdressePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Kontaktinformasjon_InternettAdresse_feature",
						"_UI_Kontaktinformasjon_type"),
				Bht2Package.Literals.KONTAKTINFORMASJON__INTERNETT_ADRESSE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bht2Package.Literals.KONTAKTINFORMASJON__POSTADRESSE);
			childrenFeatures.add(Bht2Package.Literals.KONTAKTINFORMASJON__KONTAKTPERSON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Bht2Package.Literals.KONTAKTINFORMASJON__POSTADRESSE,
				Bht2Factory.eINSTANCE.createPostadresse()));

		newChildDescriptors.add(createChildParameter(Bht2Package.Literals.KONTAKTINFORMASJON__KONTAKTPERSON,
				Bht2Factory.eINSTANCE.createKontaktperson()));
	}
