...
/**
 * This is the item provider adapter for a {@link bedriftshelsetjenesten.Postadresse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAdressePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Bht2Package.Literals.POSTADRESSE__ADRESSE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Postadresse_Postnr_feature",
								"_UI_Postadresse_type"),
						Bht2Package.Literals.POSTADRESSE__POSTNR, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Postadresse_Poststed_feature",
								"_UI_Postadresse_type"),
						Bht2Package.Literals.POSTADRESSE__POSTSTED, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Postadresse_kommune_feature",
								"_UI_Postadresse_type"),
						Bht2Package.Literals.POSTADRESSE__KOMMUNE, true, false, true, null, null, null));
	}
