...
/**
 * This is the item provider adapter for a {@link bedriftshelsetjenesten.Fylke} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FylkeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFylkenrPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Bht2Package.Literals.FYLKE__FYLKENR, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Fylke_Fylkenavn_feature",
								"_UI_Fylke_type"),
						Bht2Package.Literals.FYLKE__FYLKENAVN, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bht2Package.Literals.FYLKE__KOMMUNER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Bht2Package.FYLKE__FYLKENR:
		case Bht2Package.FYLKE__FYLKENAVN:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Bht2Package.FYLKE__KOMMUNER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(Bht2Package.Literals.FYLKE__KOMMUNER, Bht2Factory.eINSTANCE.createKommune()));
	}
