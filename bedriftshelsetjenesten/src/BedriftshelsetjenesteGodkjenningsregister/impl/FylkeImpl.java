...
public class FylkeImpl extends MinimalEObjectImpl.Container implements Fylke {
	...
	protected EClass eStaticClass() {
		return BedriftshelsetjenestenPackage.Literals.FYLKE;
	}
	...
	public void setFylkenr(int newFylkenr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BedriftshelsetjenestenPackage.FYLKE__FYLKENR,
					oldFylkenr, fylkenr));
	}
	...
	public void setFylkenavn(String newFylkenavn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BedriftshelsetjenestenPackage.FYLKE__FYLKENAVN,
					oldFylkenavn, fylkenavn));
	}
