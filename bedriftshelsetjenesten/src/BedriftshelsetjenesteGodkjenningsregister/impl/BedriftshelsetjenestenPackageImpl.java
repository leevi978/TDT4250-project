 ...
 * @generated
 */
public class BedriftshelsetjenestenPackageImpl extends EPackageImpl implements BedriftshelsetjenestenPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see BedriftshelsetjenesteGodkjenningsregister.BedriftshelsetjenestenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BedriftshelsetjenestenPackageImpl() {
		super(eNS_URI, BedriftshelsetjenestenFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link BedriftshelsetjenestenPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BedriftshelsetjenestenPackage init() {
		if (isInited)
			return (BedriftshelsetjenestenPackage) EPackage.Registry.INSTANCE
					.getEPackage(BedriftshelsetjenestenPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBedriftshelsetjenestenPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BedriftshelsetjenestenPackageImpl theBedriftshelsetjenestenPackage = registeredBedriftshelsetjenestenPackage instanceof BedriftshelsetjenestenPackageImpl
				? (BedriftshelsetjenestenPackageImpl) registeredBedriftshelsetjenestenPackage
				: new BedriftshelsetjenestenPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theBedriftshelsetjenestenPackage.createPackageContents();
		...
		EPackage.Registry.INSTANCE.put(BedriftshelsetjenestenPackage.eNS_URI, theBedriftshelsetjenestenPackage);
		return theBedriftshelsetjenestenPackage;
	}
