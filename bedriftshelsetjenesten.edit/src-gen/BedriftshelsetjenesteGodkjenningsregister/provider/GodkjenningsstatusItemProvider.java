	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BedriftshelsetjenestenPackage.Literals.GODKJENNINGSSTATUS__STATUS, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Godkjenningsstatus_Soeknadsdato_feature",
								"_UI_Godkjenningsstatus_type"),
						BedriftshelsetjenestenPackage.Literals.GODKJENNINGSSTATUS__SOEKNADSDATO, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
