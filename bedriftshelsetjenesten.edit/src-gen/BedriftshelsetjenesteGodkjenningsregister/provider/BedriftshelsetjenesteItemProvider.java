...
/**
 * This is the item provider adapter for a {@link BedriftshelsetjenesteGodkjenningsregister.Bedriftshelsetjeneste} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BedriftshelsetjenesteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addKontaktinformasjonPropertyDescriptor(object);
			addAvdelingerPropertyDescriptor(object);
			addGodkjenningsstatusPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Bedriftshelsetjeneste_Navn_feature",
								"_UI_Bedriftshelsetjeneste_type"),
						BedriftshelsetjenestenPackage.Literals.BEDRIFTSHELSETJENESTE__NAVN, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Kontaktinformasjon feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addKontaktinformasjonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Bedriftshelsetjeneste_Kontaktinformasjon_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Bedriftshelsetjeneste_Kontaktinformasjon_feature",
						"_UI_Bedriftshelsetjeneste_type"),
				BedriftshelsetjenestenPackage.Literals.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON, true, false, true,
				null, null, null));
	}

	/**
	 * This adds a property descriptor for the Avdelinger feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAvdelingerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Bedriftshelsetjeneste_Avdelinger_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Bedriftshelsetjeneste_Avdelinger_feature",
								"_UI_Bedriftshelsetjeneste_type"),
						BedriftshelsetjenestenPackage.Literals.BEDRIFTSHELSETJENESTE__AVDELINGER, true, false, true,
						null, null, null));
	}

	/**
	 * This adds a property descriptor for the Godkjenningsstatus feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGodkjenningsstatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Bedriftshelsetjeneste_Godkjenningsstatus_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Bedriftshelsetjeneste_Godkjenningsstatus_feature",
						"_UI_Bedriftshelsetjeneste_type"),
				BedriftshelsetjenestenPackage.Literals.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS, true, false, true,
				null, null, null));
	}
