...
/**
 * This is the item provider adapter for a {@link BedriftshelsetjenesteGodkjenningsregister.Kommune} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Kommune_Kommunenr_feature",
								"_UI_Kommune_type"),
						BedriftshelsetjenestenPackage.Literals.KOMMUNE__KOMMUNENR, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Kommune_Kommunenavn_feature",
								"_UI_Kommune_type"),
						BedriftshelsetjenestenPackage.Literals.KOMMUNE__KOMMUNENAVN, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Kommune_Fylke_feature",
								"_UI_Kommune_type"),
						BedriftshelsetjenestenPackage.Literals.KOMMUNE__FYLKE, true, false, true, null, null, null));
	}
