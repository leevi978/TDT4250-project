 ...
 * </p>
 * <ul>
 *   <li>{@link bedriftshelsetjenesten.impl.KommuneImpl#getKommunenr <em>Kommunenr</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KommuneImpl#getKommunenavn <em>Kommunenavn</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KommuneImpl#getFylke <em>Fylke</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KommuneImpl extends MinimalEObjectImpl.Container implements Kommune {
	...
	protected EClass eStaticClass() {
		return Bht2Package.Literals.KOMMUNE;
	}
	...
	public void setKommunenr(int newKommunenr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KOMMUNE__KOMMUNENR, oldKommunenr,
					kommunenr));
	}
	...
	public void setKommunenavn(String newKommunenavn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KOMMUNE__KOMMUNENAVN, oldKommunenavn,
					kommunenavn));
	}
	...
	public Fylke getFylke() {
		if (fylke != null && fylke.eIsProxy()) {
			...
			if (fylke != oldFylke) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bht2Package.KOMMUNE__FYLKE, oldFylke,
							fylke));
			}
		}
		return fylke;
	...
	public void setFylke(Fylke newFylke) {
		...
		fylke = newFylke;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KOMMUNE__FYLKE, oldFylke, fylke));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Bht2Package.KOMMUNE__FYLKE:
			if (resolve)
				return getFylke();
