 ...
 * </p>
 * <ul>
 *   <li>{@link bedriftshelsetjenesten.impl.KontaktpersonImpl#getNavn <em>Navn</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KontaktpersonImpl#getRolle <em>Rolle</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KontaktpersonImpl#getTelefonDir <em>Telefon Dir</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KontaktpersonImpl#getTelefonMob <em>Telefon Mob</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.KontaktpersonImpl#getEpostadresse <em>Epostadresse</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KontaktpersonImpl extends MinimalEObjectImpl.Container implements Kontaktperson {
	...
	protected EClass eStaticClass() {
		return Bht2Package.Literals.KONTAKTPERSON;
	}
	...
	public void setNavn(String newNavn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KONTAKTPERSON__NAVN, oldNavn, navn));
	}
	...
	public void setRolle(String newRolle) {
		...
		rolle = newRolle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KONTAKTPERSON__ROLLE, oldRolle, rolle));
	}
	...
	public void setTelefonDir(String newTelefonDir) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KONTAKTPERSON__TELEFON_DIR, oldTelefonDir,
					telefonDir));
	}
	...
	public void setTelefonMob(String newTelefonMob) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KONTAKTPERSON__TELEFON_MOB, oldTelefonMob,
					telefonMob));
	}
	...
	public void setEpostadresse(String newEpostadresse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.KONTAKTPERSON__EPOSTADRESSE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Bht2Package.KONTAKTPERSON__NAVN:
			return getNavn();
		case Bht2Package.KONTAKTPERSON__ROLLE:
			return getRolle();
		case Bht2Package.KONTAKTPERSON__TELEFON_DIR:
			return getTelefonDir();
		case Bht2Package.KONTAKTPERSON__TELEFON_MOB:
			return getTelefonMob();
		case Bht2Package.KONTAKTPERSON__EPOSTADRESSE:
