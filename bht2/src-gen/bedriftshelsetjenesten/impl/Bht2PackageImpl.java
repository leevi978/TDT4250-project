 ...
 * @generated
 */
public class Bht2PackageImpl extends EPackageImpl implements Bht2Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see bedriftshelsetjenesten.Bht2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bht2PackageImpl() {
		super(eNS_URI, Bht2Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Bht2Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Bht2Package init() {
		if (isInited)
			return (Bht2Package) EPackage.Registry.INSTANCE.getEPackage(Bht2Package.eNS_URI);

		// Obtain or create and register package
		Object registeredBht2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Bht2PackageImpl theBht2Package = registeredBht2Package instanceof Bht2PackageImpl
				? (Bht2PackageImpl) registeredBht2Package
				: new Bht2PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theBht2Package.createPackageContents();

		// Initialize created meta-data
		theBht2Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBht2Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Bht2Package.eNS_URI, theBht2Package);
		return theBht2Package;
	}
	 ...
	 */
	@Override
	public Bht2Factory getBht2Factory() {
		return (Bht2Factory) getEFactoryInstance();
	}
