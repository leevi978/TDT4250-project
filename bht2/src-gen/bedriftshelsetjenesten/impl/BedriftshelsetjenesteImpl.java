...
public class BedriftshelsetjenesteImpl extends MinimalEObjectImpl.Container implements Bedriftshelsetjeneste {
	...
	protected EClass eStaticClass() {
		return Bht2Package.Literals.BEDRIFTSHELSETJENESTE;
	}
	...
	public void setOrgnr(String newOrgnr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.BEDRIFTSHELSETJENESTE__ORGNR, oldOrgnr,
					orgnr));
	}
	...
	public void setNavn(String newNavn) {
		...
		navn = newNavn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.BEDRIFTSHELSETJENESTE__NAVN, oldNavn,
					navn));
	}
	...
	public NotificationChain basicSetKontaktinformasjon(Kontaktinformasjon newKontaktinformasjon,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bht2Package.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON, oldKontaktinformasjon,
		...
		if (newKontaktinformasjon != kontaktinformasjon) {
			...
			if (kontaktinformasjon != null)
				msgs = ((InternalEObject) kontaktinformasjon).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bht2Package.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON,
	...
	public EList<Avdeling> getAvdelinger() {
		if (avdelinger == null) {
			avdelinger = new EObjectContainmentEList<Avdeling>(Avdeling.class, this,
					Bht2Package.BEDRIFTSHELSETJENESTE__AVDELINGER);
		}
		return avdelinger;
	}
	...
	public NotificationChain basicSetGodkjenningsstatus(Godkjenningsstatus newGodkjenningsstatus,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bht2Package.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS, oldGodkjenningsstatus,
		...
		if (newGodkjenningsstatus != godkjenningsstatus) {
			...
			if (godkjenningsstatus != null)
				msgs = ((InternalEObject) godkjenningsstatus).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bht2Package.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS,
