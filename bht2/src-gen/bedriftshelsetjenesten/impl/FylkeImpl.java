...
public class FylkeImpl extends MinimalEObjectImpl.Container implements Fylke {
	...
	protected EClass eStaticClass() {
		return Bht2Package.Literals.FYLKE;
	}
	...
	public void setFylkenr(int newFylkenr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.FYLKE__FYLKENR, oldFylkenr, fylkenr));
	}
	...
	public void setFylkenavn(String newFylkenavn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.FYLKE__FYLKENAVN, oldFylkenavn,
					fylkenavn));
	}
	...
	public EList<Kommune> getKommuner() {
		if (kommuner == null) {
			kommuner = new EObjectContainmentEList<Kommune>(Kommune.class, this, Bht2Package.FYLKE__KOMMUNER);
		}
		return kommuner;
	}
