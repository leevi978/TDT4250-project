 ...
 * </p>
 * <ul>
 *   <li>{@link bedriftshelsetjenesten.impl.AvdelingImpl#getNavn <em>Navn</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.AvdelingImpl#getAvdelingsleder <em>Avdelingsleder</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.AvdelingImpl#getTelefon <em>Telefon</em>}</li>
 *   <li>{@link bedriftshelsetjenesten.impl.AvdelingImpl#getPostadresse <em>Postadresse</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AvdelingImpl extends MinimalEObjectImpl.Container implements Avdeling {
	...
	protected EClass eStaticClass() {
		return Bht2Package.Literals.AVDELING;
	}
	...
	public void setNavn(String newNavn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.AVDELING__NAVN, oldNavn, navn));
	}
	...
	public void setAvdelingsleder(String newAvdelingsleder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.AVDELING__AVDELINGSLEDER,
	...
	public void setTelefon(String newTelefon) {
		...
		telefon = newTelefon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.AVDELING__TELEFON, oldTelefon, telefon));
	}
	...
	public NotificationChain basicSetPostadresse(Postadresse newPostadresse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Bht2Package.AVDELING__POSTADRESSE, oldPostadresse, newPostadresse);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPostadresse != postadresse) {
			...
			if (postadresse != null)
				msgs = ((InternalEObject) postadresse).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Bht2Package.AVDELING__POSTADRESSE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bht2Package.AVDELING__POSTADRESSE, newPostadresse,
					newPostadresse));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Bht2Package.AVDELING__POSTADRESSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Bht2Package.AVDELING__NAVN:
			return getNavn();
		case Bht2Package.AVDELING__AVDELINGSLEDER:
			return getAvdelingsleder();
		case Bht2Package.AVDELING__TELEFON:
			return getTelefon();
		case Bht2Package.AVDELING__POSTADRESSE:
