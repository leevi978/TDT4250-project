 ...
 * </ul>
 *
 * @see BedriftshelsetjenesteGodkjenningsregister.BhtPackage#getAvdeling()
 * @model
 * @generated
 */
public interface Avdeling extends EObject {
	 ...
	 * @see #setNavn(String)
	 * @see BedriftshelsetjenesteGodkjenningsregister.BhtPackage#getAvdeling_Navn()
	 * @model
	 * @generated
	 */
	String getNavn();
	 ...
	 * @see BedriftshelsetjenesteGodkjenningsregister.BhtPackage#getAvdeling_Avdelingsleder()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setTelefon(int)
	 * @see BedriftshelsetjenesteGodkjenningsregister.BhtPackage#getAvdeling_Telefon()
	 * @model
	 * @generated
	 */
	int getTelefon();
	 ...
	 * @see BedriftshelsetjenesteGodkjenningsregister.BhtPackage#getAvdeling_Postadresse()
