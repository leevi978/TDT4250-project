...
public class GodkjenningsstatusImpl extends MinimalEObjectImpl.Container implements Godkjenningsstatus {
	...
	protected EClass eStaticClass() {
		return BhtPackage.Literals.GODKJENNINGSSTATUS;
	}
	...
	public void setStatus(String newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BhtPackage.GODKJENNINGSSTATUS__STATUS, oldStatus,
					status));
	}
	...
	public void setSoeknadsdato(Date newSoeknadsdato) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BhtPackage.GODKJENNINGSSTATUS__SOEKNADSDATO,
