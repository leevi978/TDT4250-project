...
public class BedriftshelsetjenesteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOrgnrPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BhtPackage.Literals.BEDRIFTSHELSETJENESTE__ORGNR, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Bedriftshelsetjeneste_Navn_feature",
								"_UI_Bedriftshelsetjeneste_type"),
						BhtPackage.Literals.BEDRIFTSHELSETJENESTE__NAVN, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON);
			childrenFeatures.add(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__AVDELINGER);
			childrenFeatures.add(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__KONTAKTINFORMASJON,
				BhtFactory.eINSTANCE.createKontaktinformasjon()));

		newChildDescriptors.add(createChildParameter(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__AVDELINGER,
				BhtFactory.eINSTANCE.createAvdeling()));

		newChildDescriptors.add(createChildParameter(BhtPackage.Literals.BEDRIFTSHELSETJENESTE__GODKJENNINGSSTATUS,
				BhtFactory.eINSTANCE.createGodkjenningsstatus()));
	}
